			...
			<Container>
				...
				<Row>
					<Col sm={{ size: 'auto', offset: 1 }}>
						<Button className='btn btn-light' color="secondary">Print</Button>{' '}
					</Col>
					<Col sm={{ size: 'auto', offset: 1 }}>
						<Button className='btn btn-light' onClick={this.goToHomepage} color="primary">
              Go To Homepage
						</Button>{' '}
					</Col>
					<Col sm={{ size: 'auto', offset: 1 }}>
						<Button className='btn btn-light' onClick={this.goToBookings} color="primary">
