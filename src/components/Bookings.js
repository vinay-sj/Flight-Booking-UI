...
const BookingRowOne = (props) => {
	...
	return (
		<tr className='text-center'>
			...
			<td>
				<Button className='btn btn-light' onClick={onDelete}>Cancel</Button>
			</td>
		</tr>
	);
};
...
class Bookings extends React.Component {
	...
	render() {
		...
		return (
			<>
				<Button className='btn btn-light' color="secondary" size="lg" onClick={this.toggleOne} block>
					One Way Bookings
				</Button>
				<Collapse isOpen={isToggleOne}>
					<BookingTableOne bookingsRows={bookingsOne} deleteBookings={this.deleteBookings} />
				</Collapse>
				<Button className='btn btn-light' color="secondary" size="lg" onClick={this.toggleRound} block>
					Round Trip Bookings
				</Button>
				<Collapse isOpen={isToggleRound}>
					<BookingTableReturn bookingsRows={bookingsRound} deleteBookings={this.deleteBookings} />
				</Collapse>
				{/*<Button className='btn btn-light' color='secondary' size='lg' onClick={toggleCancel} block>*/}
				{/*	Cancelled Bookings*/}
				{/*</Button>*/}
